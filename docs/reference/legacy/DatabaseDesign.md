# Historical: Superseded Database Design

> This document describes the legacy project-management schema and is retained only
> as discovery evidence. The authoritative WMS database design is `docs/Database.md`.
