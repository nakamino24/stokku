# Historical: Superseded User Journey

> This document describes the legacy project-management journeys and is retained
> only as discovery evidence. The authoritative WMS journeys are `docs/UX.md`.
