# Historical: Superseded Navigation Flow

> This document describes the legacy project-management navigation and is retained
> only as discovery evidence. The authoritative WMS navigation is `docs/UX.md`.
