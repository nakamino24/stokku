# Historical: Superseded API Design

> This document describes the legacy project-management API and is retained only
> as discovery evidence. The authoritative WMS API is `docs/API.md`.
