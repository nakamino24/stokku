# Historical: Superseded Design System

> This document describes the legacy interface system and is retained only as
> discovery evidence. The authoritative WMS design system is `docs/design-system.md`.
