# Historical: Superseded UI/UX Strategy

> This document describes the legacy project-management interface and is retained
> only as discovery evidence. The authoritative WMS UX strategy is `docs/UX.md`.
