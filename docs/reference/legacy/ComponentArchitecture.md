# Historical: Superseded Component Architecture

> This document describes the legacy project-management component model and is
> retained only as discovery evidence. The authoritative WMS design system is
