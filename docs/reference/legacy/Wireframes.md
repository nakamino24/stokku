# Historical: Superseded Wireframes

> These wireframes describe the legacy project-management product and are retained
> only as discovery evidence. The authoritative WMS UX direction is `docs/UX.md`.
