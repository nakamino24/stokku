# Historical ADR-001: Hybrid Module Architecture

> **Superseded by:** ADR-0001 and ADR-0002. This decision must not be used for new
> work. It is retained to explain why the repository was re-baselined.
...
- Inventory tables prefixed conceptually as inventory\_\* or kept in same schema with clear naming
