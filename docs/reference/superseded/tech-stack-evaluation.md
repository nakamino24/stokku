# Historical: Superseded Technology Stack Evaluation
## Stokku v2.0 — Engineering Decision Records

**Version:** 2.0.0-draft  
**Status:** Superseded by `docs/tech-stack.md` and the Phase 0 ADR register.  
**Classification:** Internal — Engineering Team  
**Date:** July 2026

> This evaluation is retained as decision evidence only. Its Cloudflare Workers,
> GraphQL, Redis, and Supabase Realtime proposals do not define the approved target
> architecture. See `docs/README.md` for authority and conflict handling.
