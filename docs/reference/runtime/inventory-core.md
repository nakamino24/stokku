# Reference Runtime: Inventory Core Architecture

> This document describes current Prisma-era inventory terms and implementation
> behavior. It is reference evidence only; `docs/Database.md` and ADR-0005 define
> target ledger principles.
