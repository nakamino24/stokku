...
describe('Purchase Orders API', () => {
    ...
    it('GET /api/v1/purchase-orders should list', async () => {
        prisma.purchaseOrder.findMany.mockResolvedValue([{ id: 'po-1', poNumber: 'PO-00001', items: [] }]);
        prisma.purchaseOrder.count.mockResolvedValue(1);
        const res = await (0, supertest_1.default)(app).get('/api/v1/purchase-orders');
        expect(res.status).toBe(200);
    });
    it('POST /api/v1/purchase-orders should create', async () => {
        prisma.purchaseOrder.count.mockResolvedValue(0);
        prisma.purchaseOrder.create.mockResolvedValue({ id: 'po-1', poNumber: 'PO-00001', items: [] });
...
//# sourceMappingURL=purchase-orders.routes.test.js.map